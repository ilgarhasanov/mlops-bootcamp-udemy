...
# installed.
TCL_PREFIX='d:/data_science/MLFlow/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/data_science/MLFlow/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/data_science/MLFlow/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/data_science/MLFlow/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/data_science/MLFlow/venv\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='D:\bld\tk_1699201897784\work\tcl8.6.13\win\Release_AMD64_VC1929\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='d:/data_science/MLFlow/venv\Library\lib\tclstub86.lib'
